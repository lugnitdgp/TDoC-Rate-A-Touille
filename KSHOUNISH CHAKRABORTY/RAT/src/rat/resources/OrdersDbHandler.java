...
public class OrdersDbHandler {
    ...
    public void appendOrder(int id,ArrayList<MenuItem> menus){
        ...
        ex.printStackTrace();
           System.out.println("err in orderdbh appendo");
    ...
    public ArrayList getOrders(){
       ...
       )
        {
            ...
            System.out.println("err in orderdbh getorders");
        ex.printStackTrace();
    ...
    public void removeOrder(int id){
        ...
        Statement stmt = conn.createStatement();
         ...
         {
             String sqlq="DELETE FROM orders WHERE id="+id;
             int count=stmt.executeUpdate(sqlq);
             if(count!=0) System.out.println("deleted order");
           
         }
             
         
          catch(SQLException ex){
            System.out.println("err in orderdbh removeorder");
        ex.printStackTrace();
