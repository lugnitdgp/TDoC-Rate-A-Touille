...
public class Utils {
    public static String encryptPassword(String password,String salt){
        ...
        try{
            ...
            ex.printStackTrace();
            System.out.println("err in userdbh encrypt");
    ...
    public static ArrayList arrangeOrders(ArrayList<Order> orders){
        ...
        PriorityQueue<Order> pq=new PriorityQueue<Order>(10,new OrderComparator());//10 is the default size it dosent matter
