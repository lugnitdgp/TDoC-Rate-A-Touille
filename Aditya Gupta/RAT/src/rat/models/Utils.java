...
import rar.resources.OrderComparator;
...
public class Utils {
      ...
      public static ArrayList arrangeOrder(ArrayList<Order> orders){
          ArrayList<Order> arrangeOrders = new ArrayList();
          ...
          while(!pq.isEmpty()){
              arrangeOrders.add(pq.poll());
          }
          return arrangeOrders;
      }
}
